...
<div class="main">
  ...
  <div class="content">
    ...
    <div class="page-hdr">
      ...
      <?php if($can_write):?>
      <button class="btn btn-primary" onclick="openRegModal()">+ Register Patient</button>
      <?php endif;?>
    </div>
    ...
    <div class="filter-bar">
      <input type="text" id="search-q" placeholder="Search by name, patient no., doctor…" oninput="applyFilters()">
...
function applyFilters() {
    ...
    document.querySelectorAll('#patient-tbody tr[data-name]').forEach(r => {
        const ok =
            (!q    || r.dataset.name.includes(q) || r.dataset.pno.includes(q) || r.dataset.doc.toLowerCase().includes(q)) &&
